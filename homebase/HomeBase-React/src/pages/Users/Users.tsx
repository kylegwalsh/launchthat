...
const UsersBase = (props: IProps & RouteComponentProps) => {
  ...
  const [loading, data, setData, errors, setErrors, queryAPI, refreshData] = useAPI('users');
    ...
    <div className='full-container'>
      ...
      <div className='row m-0 align-center'>
        ...
        { // Remove button if user cannot edit anyways
          ...
          <Button className='m-l-a' onClick={() => props.history.push('/users/add')}>Add User</Button>
        }
      </div>
      ...
      <Route
        path='/users/:id'
        render={() => {
          return <UserModal navigateBack={navigateBack}/>;
        }}
      />
